        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeThreshold = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCards_AspNetUsers_CustomerIDId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customerIDId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    creditCardCardID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CreditCards_creditCardCardID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditCards_CustomerIDId",
                table: "CreditCards",
                column: "CustomerIDId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_creditCardCardID",
                table: "Orders",
