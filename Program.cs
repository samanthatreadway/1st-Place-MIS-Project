...
//MAKE SURE MultipleActiveResultSets=True;
String connectionString = "Server=tcp:fa25tippettowenhw3.database.windows.net,1433;Initial Catalog=fa25FinalProjectGroup23DB;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
...
// Add session services for shopping cart messages
...
// allows for shopping cart messages w/ session 
app.UseSession();
